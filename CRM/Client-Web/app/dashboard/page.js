...
export default function DashboardPage() {
  ...
  const activities = [
    ...
    { time: "10m ago", text: "Meeting summary saved for Acme Corp (auto-generated)" },
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 p-6 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">Service365 CRM — Dashboard</h1>
            <p className="text-sm text-zinc-600 dark:text-zinc-400">
              Unified workspace • AI-driven insights • Meetings, Calls & Messaging
            </p>
          </div>
          <div className="flex items-center gap-3">
            <button className="px-4 py-2 rounded-lg bg-white/80 dark:bg-zinc-800 shadow hover:scale-[1.01] transition">New Lead</button>
            <button className="px-4 py-2 rounded-lg bg-indigo-600 text-white shadow hover:bg-indigo-700 transition">Quick Brief</button>
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-pink-400 flex items-center justify-center text-white font-medium">SA</div>
          </div>
        </header>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <aside className="lg:col-span-1 space-y-6">
                ...
                {kpis.map((k) => (
                  <div key={k.id} className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900">
                    ...
                    <div className="flex items-end justify-between mt-1">
                      ...
                      <div className={`text-sm font-medium ${k.delta.startsWith("+") ? "text-green-500" : "text-rose-500"}`}>
                        {k.delta}
                      </div>
                    </div>
                    <div className="mt-2">
                      <svg width="120" height="36" viewBox="0 0 120 36" fill="none">
                        <path d={sparklinePath([3, 5, 7, 6, 8, 9, 12])} stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.7" fill="none" />
                      </svg>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-2xl p-4 shadow">
              ...
              <div className="text-sm text-zinc-600 dark:text-zinc-300">Acme Corp — Discovery Call · 10:30 AM</div>
              <ul className="mt-3 text-sm space-y-2">
                <li>• Recent activity: Email opened 2x</li>
                <li>• Priority: High (Deal value: $12.4k)</li>
                <li>• Suggested talking points: Pricing tiers, Integration timeline</li>
              </ul>
              <div className="mt-4 flex gap-2">
                <button className="flex-1 px-3 py-2 rounded-md bg-emerald-600 text-white">Voice Brief</button>
                <button className="px-3 py-2 rounded-md bg-white/80 dark:bg-zinc-700">Summary</button>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-2xl p-4 shadow">
              ...
              <div className="text-sm text-zinc-600 dark:text-zinc-300">WhatsApp • Telegram • SMS • Messenger</div>
              ...
              <div className="bg-white dark:bg-zinc-800 rounded-2xl p-4 shadow">
                ...
                <div className="h-56 flex items-center justify-center">
                  <svg viewBox="0 0 600 200" className="w-full h-full">
                    ...
                    <path d="M0,150 C80,120 160,90 240,110 C320,130 400,80 480,60 C560,40 600,30 600,30 L600,200 L0,200 Z" fill="url(#g1)" />
                    <path d="M0,150 C80,120 160,90 240,110 C320,130 400,80 480,60 C560,40 600,30" fill="none" stroke="#7c3aed" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                  ...
                  {pipeline.map((p, i) => (
                    <div key={i} className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900 text-center">
                      ...
                      <div className="h-12 mt-2 flex items-end justify-center">
                        <div style={{ height: `${Math.max(6, (p.count / 450) * 100)}%` }} className="w-3 bg-indigo-500 rounded-t-md" />
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="lg:col-span-2 bg-white dark:bg-zinc-800 rounded-2xl p-4 shadow">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className="text-xs text-zinc-500 mb-2">Recent Messages</div>
                    <div className="space-y-3">
                      <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900">
                        <div className="flex items-center justify-between">
                          <div className="text-sm font-medium">John D • WhatsApp</div>
                          <div className="text-xs text-zinc-500">10:12</div>
                        </div>
                        <div className="text-sm mt-1">Hi, can we get a demo of the integration this week?</div>
                        <div className="mt-2 flex gap-2 text-xs">
                          <button className="px-2 py-1 rounded bg-indigo-600 text-white">Reply</button>
                          <button className="px-2 py-1 rounded bg-white/80 dark:bg-zinc-700">Create Lead</button>
                          <button className="px-2 py-1 rounded bg-white/80 dark:bg-zinc-700">Add to Sequence</button>
                        </div>
                      </div>
                      <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900">
                        <div className="flex items-center justify-between">
                          <div className="text-sm font-medium">Acme Corp • Call</div>
                          <div className="text-xs text-zinc-500">08:40</div>
                        </div>
                        <div className="text-sm mt-1">AI Summary: Client interested in 3rd-party integration. Follow up with pricing tiers.</div>
                        <div className="mt-2 flex gap-2 text-xs">
                          <button className="px-2 py-1 rounded bg-emerald-600 text-white">View Summary</button>
                          <button className="px-2 py-1 rounded bg-white/80 dark:bg-zinc-700">Assign</button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white dark:bg-zinc-800 rounded-2xl p-4 shadow">
                ...
                <ul className="mt-3 space-y-3 text-sm">
                  <li className="p-2 rounded-lg bg-zinc-50 dark:bg-zinc-900">
                    ...
                    <div className="text-zinc-500">Lead: Marina Co • Score: 82 • Suggested channel: WhatsApp</div>
                  </li>
                  <li className="p-2 rounded-lg bg-zinc-50 dark:bg-zinc-900">
                    <div className="font-medium">Upsell opportunity</div>
                    <div className="text-zinc-500">Client: BrightTech • Product: Enterprise • Probability: 47%</div>
                  </li>
                </ul>
              </div>
            </div>
